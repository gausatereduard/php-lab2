...
3. Используйте переход на новую строку в выводе используя тэг `<br />`.
   ...
   ![scr4](assets/scr4.png)

## Финальный код и результат
...
![scr5](assets/scr5.png)

## Контрольные вопросы

1. Какие способы установки PHP существуют?
   - Напрямую с сайта php.net, XAMPP или OpenServer
2. Как проверить, что PHP установлен и работает?
   - `php -v`
3. Чем отличается оператор `echo` от `print`?
   - `print` - принимает только 1 параметр, возвращает 1, всегда (`print "Hello", "Rayan", "Reynolds"` - будет ошибка)
   - `echo` - принимает множество параметров, ничего не возвращает
